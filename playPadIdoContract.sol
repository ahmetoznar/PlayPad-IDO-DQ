...
contract PlayPadSale is ReentrancyGuard, Ownable {

    MainPlayPadContract deployedMainContract;
    ...
    constructor(
        ...
        endTime = _endTime;
        mainContractAddress = MainPlayPadContract(_mainContractAddress);
    }
    
    event NewBuying(address indexed investorAddress, uint256 amount, uint256 timestamp);
    
    function buyToken() nonReentrant {
        require(block.timestamp >= startTime);
        require(block.timestamp <= endTime);
        investorData = MainPlayPadContract(_mainContractAddress).getInvestorInfo(this, msg.sender);
        require(investorData[0]);
        require(maxBuyValue <= investor.totalBuyingAmountBNB.add(msg.value));
    ...
    function addAddressesToList(address _address) external onlyOwner nonReentrant{ 
